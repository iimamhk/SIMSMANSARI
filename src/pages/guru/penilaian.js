    ...
    <div class="space-y-2.5 sm:space-y-4">
        ...
        <div class="relative">
          <div class="flex items-center gap-2.5 sm:gap-4">
            ...
            <div class="min-w-0 flex-[1.55] sm:max-w-xl">
                <select id="assignment-select" aria-label="Pilih kelas dan mata pelajaran aktif" class="w-full truncate rounded-xl border border-blue-200 bg-gradient-to-r from-blue-50 via-white to-indigo-50 px-3 py-2.5 text-sm font-semibold text-slate-900 shadow-md shadow-blue-200/60 outline-none transition focus:border-blue-400 focus:ring-4 focus:ring-blue-100 sm:rounded-2xl sm:px-4 sm:py-3">
      ...
      <div class="overflow-hidden rounded-[22px] border border-slate-200/80 bg-white shadow-sm ring-1 ring-black/[0.02] sm:rounded-[28px] sm:shadow-[0_24px_70px_-34px_rgba(15,23,42,0.35)]">
        <div class="border-b border-slate-200/70 bg-slate-50/90 p-1.5 sm:px-4 sm:py-3">
          ...
          <button id="tab-laporan" class="flex min-w-0 items-center justify-center gap-1.5 rounded-full border border-slate-200/80 bg-white/80 px-2 py-1.5 text-center text-[10px] font-semibold text-slate-600 shadow-sm transition hover:bg-white hover:text-slate-900 hover:ring-1 hover:ring-emerald-200 whitespace-normal sm:whitespace-nowrap" data-tab="laporan"><svg class="h-3.5 w-3.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg><span>Laporan</span></button>
          </div>
        </div>
