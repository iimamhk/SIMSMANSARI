  ...
  container.querySelector('#settings-form')?.addEventListener('submit', async (event) => {
    ...
    try {
      ...
      const mergedUser = {
        ...
        nama: currentUser.nama || firestoreCurrentUser?.nama || cachedCurrentUser.nama || 'Guru',
        role: currentUser.role || firestoreCurrentUser?.role || cachedCurrentUser.role || 'guru',
