    ...
    <div class="space-y-6">
      ...
      <section>
        <div class="rounded-3xl bg-white p-5 shadow-md ring-1 ring-slate-100">
          ...
          ${quickCard('#siswa/kuiz', 'Ujian', 'Masuk ke ujian kelas.', 'from-violet-500 to-purple-600', '<path d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2"/><rect x="9" y="3" width="6" height="4" rx="1"/><path d="M9 12h6M9 16h4"/>')}
